			...
			case 'search':
				...
				if ($keywords)
				{
					...
					if ($search_count > 0)
					{
						...
						$sql_array = array(
							'SELECT'	=> 'msg.msg_id as msg_id, msg.message_subject as msg_subject, msg.message_time as msg_time, msg.author_id as msg_author, MAX(tmsg.pm_unread) as unread, MAX(tmsg.pm_replied) as replied',
							'FROM'	=> array(
								PRIVMSGS_TABLE => 'msg',
